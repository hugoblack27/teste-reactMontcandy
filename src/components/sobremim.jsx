  ...
  return (
    <div>
      <section className="sobre-mim" id="sobre-mim">
        <section className="section-pattern container rounded-3 p-4 p-md-5 shadow-lg">
          ...
          <div className="row align-items-center g-5">
            ...
            <div className="foto-sobremim position-relative col-md-6">
              <img
                src={fotodona}
            ...
            <div className="col-md-6">
              ...
              >
                "A verdadeira doçura está na paixão com que cada criação é
                feita"
              </blockquote>
            </div>
          </div>
